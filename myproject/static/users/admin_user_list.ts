document.addEventListener('DOMContentLoaded', () => {
    ...
    const buttons = document.querySelectorAll<HTMLButtonElement>('.toggle-permission');
    ...
    buttons.forEach((button) => {
        button.addEventListener('click', () => {
            ...
            const csrfToken = (document.querySelector<HTMLInputElement>('input[name="csrfmiddlewaretoken"]')?.value) || '';
            ...
            .then((data) => {
                ...
                if (statusCell) {
                    statusCell.textContent = data.is_permitted ? 'Zugelassen' : 'Nicht zugelassen';
                }
