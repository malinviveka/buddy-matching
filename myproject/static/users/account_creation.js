...
submitAccountButton.addEventListener("click", (event) =>
  __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const accountCreationForm = document.getElementById(
          "accountCreationForm",
        );
        const submitAccountButton = document.getElementById(
          "submitAccountButton",
        );
        const messageDiv = document.getElementById("message");
        submitAccountButton.addEventListener("click", (event) =>
        ...
        document.addEventListener("DOMContentLoaded", () => {
          ...
          const updateSpecialFields = () => {
            ...
            const countryLabel =
              (_a =
                countryField === null || countryField === void 0
                  ? void 0
                  : countryField.parentElement) === null || _a === void 0
                ? void 0
                : _a.querySelector("label");
            if (getCurrentLanguage() === "en") {
              if (selectedRole === "Buddy") {
                ...
                countryField.placeholder =
                  "Enter country of sending university";
              }
            } else {
              if (selectedRole === "Buddy") {
                ...
                countryField.placeholder =
                  "Gib das Land deiner sendenden Universität an";
              }
            }
          };
